    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a] flex flex-col">
      ...
      <div className="flex flex-1 max-w-[1400px] w-full mx-auto pt-6">
        ...
        <main className="flex-1 ml-8 pr-8 pb-12 w-full">
          {/* Page Title */}
          <h1 className="text-[28px] font-extrabold text-slate-800 dark:text-[#f8fafc] mb-3">Thẻ Tags</h1>

          {/* Description */}
          <p className="text-gray-700 dark:text-[#94a3b8] mb-8 leading-relaxed">
          ...
          <div className="bg-white dark:bg-[#1e293b] rounded-lg shadow-md dark:shadow-[0_4px_12px_rgba(0,0,0,0.2)] p-6 mb-8 border border-transparent dark:border-[#334155]">
              ...
              <div className="flex-1">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 dark:border-[#334155] dark:bg-[#334155] rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-500/20 dark:text-[#f8fafc] dark:placeholder:text-[#94a3b8]"
                  />
                </div>
              </div>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className={`px-4 py-2 rounded font-medium transition ${sortBy === 'popular'
                    ...
                    : 'bg-gray-100 dark:bg-[#334155] text-gray-700 dark:text-[#94a3b8] hover:bg-gray-200 dark:hover:bg-[#334155]/80'
                    }`}
                >
                  Phổ biến nhất
                </button>
          ...
          {isLoading ? (
            ...
            <div className="flex justify-center py-20 bg-white dark:bg-[#1e293b] rounded-lg shadow-sm border border-transparent dark:border-[#334155]">
              <span className="text-slate-500 dark:text-[#94a3b8] font-medium">Không tìm thấy thẻ nào phù hợp.</span>
            </div>
          ) : (
                ...
                <div key={tag._id} className="bg-white dark:bg-[#1e293b] rounded-lg shadow-md dark:shadow-[0_2px_8px_rgba(0,0,0,0.2)] p-6 hover:shadow-lg transition cursor-pointer border border-transparent dark:border-[#334155]" onClick={() => navigate(`/questions?tag=${encodeURIComponent(tag.name)}`)}>
                  ...
                  <div className="mt-4 space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-700 dark:text-[#f8fafc] font-semibold">{formatNumber(tag.totalQuestion || 0)}</span>
                      <span className="text-gray-500 dark:text-[#94a3b8]">câu hỏi</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700 dark:text-[#f8fafc] font-semibold">{formatNumber(tag.viewCount || 0)}</span>
                      <span className="text-gray-500 dark:text-[#94a3b8]">lượt xem</span>
                    </div>
                  </div>
                </div>
              ))}
          ...
          {totalPages > 1 && (
            <div className="flex justify-center items-center gap-2">
              <button
                ...
                className="p-2 rounded hover:bg-gray-200 dark:hover:bg-[#334155] transition disabled:opacity-50"
              >
                <ChevronLeft size={20} className="text-gray-600 dark:text-[#94a3b8]" />
              </button>
              ...
              {Array.from({ length: totalPages }).map((_, index) => {
                ...
                if (p === 1 || p === totalPages || (p >= currentPage - 1 && p <= currentPage + 1)) {
                  return (
                    <button
                      ...
                      className={`px-4 py-2 rounded font-medium transition ${currentPage === p
                        ...
                        : "hover:bg-gray-200 dark:hover:bg-[#334155] text-gray-700 dark:text-[#94a3b8]"
                        }`}
                    >
                      {p}
                    </button>
                  ...
                  return <span key={p} className="text-gray-500 dark:text-[#94a3b8] px-2">...</span>
                }
                return null;
              })}
              ...
              <button
                ...
                className="p-2 rounded hover:bg-gray-200 dark:hover:bg-[#334155] transition disabled:opacity-50"
              >
                <ChevronRight size={20} className="text-gray-600 dark:text-[#94a3b8]" />
              </button>
            </div>
          )}
        </main>
