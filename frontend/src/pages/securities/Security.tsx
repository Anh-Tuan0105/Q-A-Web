          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-slate-500 dark:text-[#94a3b8] text-[12px]">Full Stack Developer</span>
              </div>
            </div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <div
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer font-bold text-[14px] transition-colors bg-[#F0F5FF] dark:bg-blue-500/10 text-blue-600 dark:text-blue-400"
              >
                <Lock className="w-[18px] h-[18px] text-blue-600 dark:text-blue-400" strokeWidth={2.5} />
                Bảo mật & Đăng nhập
              </div>
            </nav>
          </div>
